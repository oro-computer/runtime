...
test('i18n.getMessage(messageName[,substitutions = [][, options]])', (t) => {
  ...
  t.equal(
    en['key-with-indexed-substitutions'],
    'first=first, second=second, third=third',
    'en[key-with-indexed-substitutions]'
  )
  t.equal(
    en['key-with-placeholder-substitutions'],
    'first=first, second=second, third=third',
    'en[key-with-placeholder-substitutions]'
  )
  ...
  t.equal(
    fr['key-with-indexed-substitutions'],
    'premier=premier!, deuxième=deuxième!, troisième=troisième!',
    'fr[key-with-indexed-substitutions]'
  )
  t.equal(
    fr['key-with-placeholder-substitutions'],
    'premier=premier!, deuxième=deuxième!, troisième=troisième!',
    'fr[key-with-placeholder-substitutions]'
  )
})
