import { normalizeFlags } from 'oro:fs/flags'
...
test('flags', (t) => {
  ...
  t.ok(
    (normalizeFlags('sr') === fs.constants.O_RDONLY) | fs.constants.O_SYNC,
  ...
  t.ok(
    (normalizeFlags('w') === fs.constants.O_TRUNC) |
  ...
  t.ok(
    (normalizeFlags('wx') === fs.constants.O_TRUNC) |
      fs.constants.O_CREAT |
      fs.constants.O_WRONLY |
      fs.constants.O_EXCL,
  ...
  t.ok(
    (normalizeFlags('xw') === fs.constants.O_TRUNC) |
      fs.constants.O_CREAT |
      fs.constants.O_WRONLY |
      fs.constants.O_EXCL,
  ...
  t.ok(
    (normalizeFlags('xw+') === fs.constants.O_TRUNC) |
      ...
      fs.constants.O_RDWR |
      fs.constants.O_EXCL,
    'xw+ === fs.constants.O_TRUNC | fs.constants.O_CREAT | fs.constants.O_RDWR | fs.constants.O_EXCL'
  )

  t.ok(
    (normalizeFlags('a') === fs.constants.O_APPEND) |
      fs.constants.O_CREAT |
      fs.constants.O_WRONLY,
  ...
  t.ok(
    (normalizeFlags('ax') === fs.constants.O_APPEND) |
      fs.constants.O_CREAT |
      fs.constants.O_WRONLY |
      fs.constants.O_EXCL,
  ...
  t.ok(
    (normalizeFlags('xa') === fs.constants.O_APPEND) |
      fs.constants.O_CREAT |
      fs.constants.O_WRONLY |
      fs.constants.O_EXCL,
  ...
  t.ok(
    (normalizeFlags('as') === fs.constants.O_APPEND) |
      fs.constants.O_CREAT |
      fs.constants.O_WRONLY |
      fs.constants.O_SYNC,
  ...
  t.ok(
    (normalizeFlags('sa') === fs.constants.O_APPEND) |
      fs.constants.O_CREAT |
      fs.constants.O_WRONLY |
      fs.constants.O_SYNC,
