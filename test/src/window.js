import ApplicationWindow, { constants, formatURL } from 'oro:window'
import * as hotkey from 'oro:window/hotkey'
import { test } from 'oro:test'
import os from 'oro:os'

test('window constants', (t) => {
  t.equal(
    ApplicationWindow.constants.WINDOW_ERROR,
    -1,
    'ApplicationWindow.constants.WINDOW_ERROR is -1'
  )
  t.equal(
    ApplicationWindow.constants.WINDOW_NONE,
    0,
    'ApplicationWindow.constants.WINDOW_NONE is 0'
  )
  t.equal(
    ApplicationWindow.constants.WINDOW_CREATING,
    10,
    'ApplicationWindow.constants.WINDOW_CREATING is 10'
  )
  t.equal(
    ApplicationWindow.constants.WINDOW_CREATED,
    11,
    'ApplicationWindow.constants.WINDOW_CREATED is 11'
  )
  t.equal(
    ApplicationWindow.constants.WINDOW_HIDING,
    20,
    'ApplicationWindow.constants.WINDOW_HIDING is 20'
  )
  t.equal(
    ApplicationWindow.constants.WINDOW_HIDDEN,
    21,
    'ApplicationWindow.constants.WINDOW_HIDDEN is 21'
  )
  t.equal(
    ApplicationWindow.constants.WINDOW_SHOWING,
    30,
    'ApplicationWindow.constants.WINDOW_SHOWING is 30'
  )
  t.equal(
    ApplicationWindow.constants.WINDOW_SHOWN,
    31,
    'ApplicationWindow.constants.WINDOW_SHOWN is 31'
  )
  t.equal(
    ApplicationWindow.constants.WINDOW_CLOSING,
    40,
    'ApplicationWindow.constants.WINDOW_CLOSING is 40'
  )
  t.equal(
    ApplicationWindow.constants.WINDOW_CLOSED,
    41,
    'ApplicationWindow.constants.WINDOW_CLOSED is 41'
  )
  t.equal(
    ApplicationWindow.constants.WINDOW_EXITING,
    50,
    'ApplicationWindow.constants.WINDOW_EXITING is 50'
  )
  t.equal(
    ApplicationWindow.constants.WINDOW_EXITED,
    51,
    'ApplicationWindow.constants.WINDOW_EXITED is 51'
  )
  t.equal(
    ApplicationWindow.constants.WINDOW_KILLING,
    60,
    'ApplicationWindow.constants.WINDOW_KILLING is 60'
  )
  t.equal(
    ApplicationWindow.constants.WINDOW_KILLED,
    61,
    'ApplicationWindow.constants.WINDOW_KILLED is 61'
  )
...
test('formatURL', (t) => {
  t.equal(
    ...
    'oro://computer.oro.runtime.tests/index.html'
  )
})
...
if (!/android|ios/.test(os.platform())) {
  test('window - hotkey', async (t) => {
    ...
    t.ok(
      bindings?.length === 0,
      'no binding exists in bindings array after unbind'
    )
  })
}
