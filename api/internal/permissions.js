  ...
  if (name === 'camera' || name === 'microphone') {
    if (!globalThis.navigator.mediaDevices) {
      if (globalThis.isServiceWorkerScope) {
        throw new TypeError(
          'MediaDevices are not supported in ServiceWorkerGlobalScope.'
        )
      } else if (globalThis.isSharedWorkerScope) {
        throw new TypeError(
          'MediaDevices are not supported in SharedWorkerGlobalScope.'
        )
      } else if (globalThis.isWorkerScope) {
        throw new TypeError(
          'MediaDevices are not supported in WorkerGlobalScope.'
        )
      } else {
