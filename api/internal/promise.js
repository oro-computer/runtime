...
Promise.all = function (iterable) {
  return NativePromiseAll.call(
    NativePromise,
    Array.from(iterable).map((promise, index) => {
      ...
      return promise.catch((err) => {
        return Promise.reject(
          Object.defineProperties(err, {
            [Symbol.for('oro.runtime.CallSite.PromiseElementIndex')]: {
              configurable: true,
              enumerable: false,
              writable: false,
              value: index
            ...
            [Symbol.for('oro.runtime.CallSite.PromiseAll')]: {
              configurable: true,
              enumerable: false,
              writable: false,
              value: true
      ...
      return promise.catch((err) => {
        return Promise.reject(
          Object.defineProperties(err, {
            ...
            [Symbol.for('oro.runtime.CallSite.PromiseAny')]: {
              configurable: true,
              enumerable: false,
              writable: false,
              value: true
        ...
        if (typeof arg === 'function') {
          return asyncHooks.wrap(
            ...
            resource?.triggerAsyncId?.() ??
              asyncHooks.getDefaultExecutionAsyncId(),
            resource ?? undefined
          )
        }
