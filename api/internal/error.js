      ...
      get: () => {
        ...
        if (Error.stackTraceLimit === 0) {
          ...
          const prepareStackTrace =
            Constructor.prepareStackTrace || globalThis.Error.prepareStackTrace
 ...
 */
function installRuntimeError (PlatformError) {
  if (!PlatformError) {
  ...
  Object.defineProperty(Error, 'captureStackTrace', {
    ...
    value(target) {
      ...
      if (target instanceof Error) {
        ...
        const prepareStackTrace =
          Error.prepareStackTrace || globalThis.Error.prepareStackTrace
        if (typeof prepareStackTrace === 'function') {
...
export const OverconstrainedError = installRuntimeError(
  globalThis.OverconstrainedError
)
export const GeolocationPositionError = installRuntimeError(
