...
const AsyncGeneratorPrototype = Object.getPrototypeOf((function * () {})())
...
function matchesPrototype (prototype, input) {
  return Object.prototype.isPrototypeOf.call(prototype, input)
}
 ...
 * @return {boolean}
 */
export function isExternal (_input) {
  return false
}
...
export function isGeneratorObject (input) {
  return (
    input &&
    typeof input === 'object' &&
    matchesPrototype(GeneratorPrototype, input)
  )
}
...
export function isIterator (input) {
  return (
    input &&
    typeof input === 'object' &&
    matchesPrototype(IteratorPrototype, input)
  )
}
...
export function isAsyncIterator (input) {
  return (
    input &&
    typeof input === 'object' &&
    matchesPrototype(AsyncIteratorPrototype, input)
  )
}
...
export function isMapIterator (input) {
  return (
    input &&
    typeof input === 'object' &&
    matchesPrototype(MapIteratorPrototype, input)
  )
}
...
export function isSetIterator (input) {
  return (
    input &&
    typeof input === 'object' &&
    matchesPrototype(SetIteratorPrototype, input)
  )
}
 ...
 * @return {boolean}
 */
export function isProxy (_input) {
  return false
}
 ...
 * @return {boolean}
 */
export function isKeyObject (_input) {
  return false
}
 ...
 * @return {boolean}
 */
export function isCryptoKey (_input) {}
