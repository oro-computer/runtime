 ...
 */
export const ADDR_RESTRICTED =
  FIREWALL_ALLOW_KNOWN_IP | MAPPING_ENDPOINT_INDEPENDENT
 ...
 */
export const PORT_RESTRICTED =
  FIREWALL_ALLOW_KNOWN_IP_AND_PORT | MAPPING_ENDPOINT_INDEPENDENT
 ...
 */
export const ENDPOINT_RESTRICTED =
  FIREWALL_ALLOW_KNOWN_IP_AND_PORT | MAPPING_ENDPOINT_DEPENDENT
 ...
 */
export const isValid = (nat) =>
  isEndpointDependenceDefined(nat) && isFirewallDefined(nat)
...
export const toStringStrategy = (n) => {
  switch (n) {
    ...
    case STRATEGY_DIRECT_CONNECT:
      return 'STRATEGY_DIRECT_CONNECT'
    case STRATEGY_TRAVERSAL_OPEN:
      return 'STRATEGY_TRAVERSAL_OPEN'
    case STRATEGY_TRAVERSAL_CONNECT:
      return 'STRATEGY_TRAVERSAL_CONNECT'
    case STRATEGY_PROXY:
    ...
    case ADDR_RESTRICTED: {
      switch (a) {
        case UNRESTRICTED:
          return STRATEGY_DEFER
        case ADDR_RESTRICTED:
          return STRATEGY_DIRECT_CONNECT // both sides attempt, one will succeed
        case PORT_RESTRICTED:
          return STRATEGY_DIRECT_CONNECT // a is hinting, b is guessing
        case ENDPOINT_RESTRICTED:
          return STRATEGY_DIRECT_CONNECT // a is hinting, b is guessing
      }
      break
    ...
    case PORT_RESTRICTED: {
      switch (a) {
        case UNRESTRICTED:
          return STRATEGY_DEFER
        case ADDR_RESTRICTED:
          return STRATEGY_DIRECT_CONNECT // a is guessing, b is hinting
        case PORT_RESTRICTED:
          return STRATEGY_DIRECT_CONNECT // both guess, will take too long, most resign to proxying
        case ENDPOINT_RESTRICTED:
          return STRATEGY_TRAVERSAL_CONNECT // try connecting
      }
      break
    }
    ...
    case ENDPOINT_RESTRICTED: {
      switch (a) {
        case UNRESTRICTED:
          return STRATEGY_DEFER
        case ADDR_RESTRICTED:
          return STRATEGY_DIRECT_CONNECT // the 3 successive packets will penetrate
        case PORT_RESTRICTED:
          return STRATEGY_TRAVERSAL_OPEN // open up some ports
        case ENDPOINT_RESTRICTED:
          return STRATEGY_PROXY // unroutable
      }
    }
  }
