...
const channel = new BroadcastChannel('oro.runtime.serviceWorker')
...
export async function showNotification (registration, title, options) {
  ...
  const info =
    registration[Symbol.for('oro.runtime.ServiceWorkerRegistration.info')]
  ...
  options = new NotificationOptions(
    options,
    /* allowServiceWorkerGlobalScope= */ true
  )
