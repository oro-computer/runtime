    ...
    async value (type) {
      ...
      if (this.id && type === 'serviceWorker') {
        debug(
          ...
          new URL(this.serviceWorker.scriptURL).pathname.replace(
            /^\/oro\//,
            'oro:'
          ),
          this.id,
...
if (globalThis.document) {
  ...
  globalThis.document.addEventListener('visibilitychange', (_event) => {
  ...
  globalThis.addEventListener('focus', (_event) => {
  ...
  globalThis.addEventListener('blur', (_event) => {
