...
#ifndef CRANIUM_FUNCTION_H
#define CRANIUM_FUNCTION_H
...
// applies tanh function to each entry of input
...
// sample from the unit gaussian distribution (mean = 0, variance = 1)
