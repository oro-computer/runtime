...
namespace oro::runtime::tls {
  ...
  static void evaluateVerification(Client::Impl* impl) {
  ...
  static HRESULT loadClientIdentity(Client::Impl* impl, const String& certPem, const String& keyPem, const String& passphrase) {
