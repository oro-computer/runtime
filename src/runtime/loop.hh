#ifndef ORO_RUNTIME_LOOP_H
#define ORO_RUNTIME_LOOP_H
...
namespace oro::runtime::loop {
  ...
  class Loop {
    public:
       ...
       */
      struct Options : public oro::runtime::Options {
      #if ORO_RUNTIME_PLATFORM_ANDROID || ORO_RUNTIME_PLATFORM_WINDOWS || ORO_RUNTIME_DESKTOP_EXTENSION
