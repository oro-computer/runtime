#ifndef ORO_RUNTIME_APP_H
#define ORO_RUNTIME_APP_H
...
@interface OROApplicationDelegate :
...
@property (nonatomic, assign) oro::runtime::SharedPointer<oro::runtime::app::App> app;
@end
#endif
  ...
  class App {
    public:
      ...
      struct Options : public runtime::Options {
        ...
        Runtime::BackgroundOptions background;
      ...
      // Deduplicate rapid lifecycle emits (ms since steady clock epoch)
      Atomic<uint64_t> lastPauseEmitMs = 0;
      Atomic<uint64_t> lastResumeEmitMs = 0;
      Atomic<uint64_t> lastStopEmitMs = 0;
      ...
      OROApplicationDelegate* delegate = nullptr;
    #if ORO_RUNTIME_PLATFORM_MACOS
