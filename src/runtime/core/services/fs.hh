#ifndef ORO_RUNTIME_CORE_SERVICES_FS_H
#define ORO_RUNTIME_CORE_SERVICES_FS_H
...
namespace oro::runtime::core::services {
  class FS : public core::Service {
    public:
      ...
      void lchmod (const ipc::Message::Seq&, const String&, int, const Callback) const;
      ...
      void fdatasync (const ipc::Message::Seq&, ID, const Callback) const;
      ...
      void lutimes (const ipc::Message::Seq&, const String&, double, double, const Callback) const;
      void utimes (const ipc::Message::Seq&, const String&, double, double, const Callback) const;
      void futimes (const ipc::Message::Seq&, ID, double, double, const Callback) const;
      void mkdir (const ipc::Message::Seq&, const String&, int, bool, const Callback) const;
      void mkdtemp (const ipc::Message::Seq&, const String&, const Callback) const;
