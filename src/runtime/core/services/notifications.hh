#ifndef ORO_RUNTIME_CORE_SERVICES_NOTIFICATIONS_H
#define ORO_RUNTIME_CORE_SERVICES_NOTIFICATIONS_H
...
@interface OROUserNotificationCenterDelegate : NSObject<UNUserNotificationCenterDelegate>
@property (nonatomic) oro::runtime::core::services::Notifications* notifications;
...
namespace oro::runtime::core::services {
  class Notifications : public core::Service {
    ...
    #if ORO_RUNTIME_PLATFORM_APPLE
      OROUserNotificationCenterDelegate* userNotificationCenterDelegate = nullptr;
