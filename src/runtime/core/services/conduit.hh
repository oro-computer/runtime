#ifndef ORO_RUNTIME_CORE_SERVICES_CONDUIT_H
#define ORO_RUNTIME_CORE_SERVICES_CONDUIT_H
    ...
    public:
      ...
      class Client {
        public:
          ...
          // uv state (heap-allocated to ensure safe uv_close lifecycle)
          ...
          Client (Conduit* conduit)
            : conduit(conduit),
              id(0),
              isHandshakeDone(0) {
            this->handle = new uv_tcp_t; // initialized during accept
          }
