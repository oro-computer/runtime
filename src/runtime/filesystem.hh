#ifndef ORO_RUNTIME_FILESYSTEM_H
#define ORO_RUNTIME_FILESYSTEM_H
  ...
  class Resource : public oro::runtime::Resource {
    public:
      ...
      struct Options {
        ...
        android::ContentResolver* contentResolver = nullptr;
      #endif
      ...
      static Path resolve (const Path& resourcePath);
      static Path resolve (const String& resourcePath);
      ...
      Resource (const Path& resourcePath);
      ...
      Resource (const String& resourcePath);
  ...
  class Watcher {
    public:
      ...
      struct Handle {
        EventHandle event;
        PollHandle poll;
        AtomicBool eventInitialized = false;
        AtomicBool pollInitialized = false;
      };
