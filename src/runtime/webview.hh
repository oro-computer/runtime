#ifndef ORO_RUNTIME_WEBVIEW_H
#define ORO_RUNTIME_WEBVIEW_H
...
namespace oro::runtime::webview {
  ...
  class Navigator {
    public:
      ...
      ORONavigationDelegate* navigationDelegate = nullptr;
    #endif
  ...
  class SchemeHandlers {
    ...
    public:
      ...
      struct Request {
        ...
        // CDP instrumentation metadata (used by the runtime CDP server).
        int cdpWindowIndex = -1;
        String cdpRequestId = "";
        String cdpResourceType = "";
        Atomic<bool> cdpRequestWillBeSent = false;
        Atomic<bool> cdpResponseReceived = false;
        Atomic<bool> cdpLoadingFinished = false;
      ...
      struct Response {
        ...
        bytes::BufferQueue cdpBodyCapture;
        size_t cdpBodyCaptureBytes = 0;
        bool cdpBodyCaptureTruncated = false;
