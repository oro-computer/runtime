#ifndef ORO_RUNTIME_AI_CHAT_H
#define ORO_RUNTIME_AI_CHAT_H
  ...
  class Session {
    public:
      ...
      struct GenerateOptions {
        ...
        // Optional absolute deadline in milliseconds since steady_clock epoch
        // When > 0, generation stops as soon as now >= deadlineAtMs.
        uint64_t deadlineAtMs = 0;
        Vector<String> antiprompts;
      };
